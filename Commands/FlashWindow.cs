...
namespace talk2.Commands
{
    public class FlashWindow
    {
        private IntPtr mainWindowHWnd;
        private Window theWin;

        public FlashWindow(Window win)
        {
            this.theWin = win;
        }
        ...
        private void InitializeHandle()
        {
            if (this.mainWindowHWnd == IntPtr.Zero)
            {
                ...
                this.mainWindowHWnd = new System.Windows.Interop.WindowInteropHelper(theWin).Handle;
            }
        }
